...
const Menuitems = ({id,name,image,description,price}) => {
  ...
  return (
        ...
        <div  className="  m-3 rounded-2xl overflow-auto shadow-lg  relative ">
                ...
                {!cartitem[id]?<img src="/images/add_icon_white.png" onClick={()=>Addtocart(id)} className="absolute bottom-30 right-3 "></img>:
                <div className="flex items-center bg-white absolute bottom-30 right-3 rounded-2xl p-2">
               
                <img src="/images/remove_icon_red.png" onClick={()=>Removefromcart(id)}/>
                 <p className="px-2">{cartitem[id]}</p>
                 <img src="/images/add_icon_green.png" onClick={()=>Addtocart(id)}/>
                </div>}

                <div className="p-3 ">
                <div className="flex justify-between  items-center">
                <h1 className="font-bold">{name}</h1> <img src="/images/rating_starts.png" className="h-4"/></div>
